...
$sql = "INSERT INTO chamados 
        ...
        VALUES 
        ('$descricao', $id_solicitante, $id_ambiente, $id_tipo, 'aberto')";
...
if ($conn->query($sql)) {
    ...
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['foto']['tmp_name'], $caminho_final)) {
            ...
            $conn->query("INSERT INTO chamados_anexos 
                          (id_chamado, caminho_arquivo, tipo_anexo) 
                          VALUES 
                          ($id_chamado, '$caminho_db', 'abertura')");
        }
    }
