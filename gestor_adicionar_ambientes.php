    ...
    <nav class="navbar navbar-custom py-2 mb-5">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <span class="navbar-brand text-white fw-bold m-0">Novo Ambiente</span>
            </div>
        ...
        <div class="col-md-6 col-lg-5">
            ...
            <div class="form-card">
                <div class="text-center mb-4">
                    ...
                    <h4 class="fw-bold text-dark mt-2">Registrar Ambiente</h4>
                    <p class="text-muted small">Preencha os detalhes abaixo para que a criação de um novo ambiente.</p>
                </div>
                ...
                <form id="formChamado">
                    ...
                    <div class="mb-4">
                        <label class="form-label"> Nome do ambiente que deseja adicionar</label>
