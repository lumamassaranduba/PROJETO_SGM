            ...
            <div class="form-card">
                <div class="text-center mb-4">
                   <i class="bi bi-upload"></i>
                    ...
                    <p class="text-muted small">Preencha os detalhes abaixo para a atualização do tipo de serviço desejado.</p>
                </div>
                

                    <div class="mb-4">
                        <label class="form-label"> Atualização do serviço</label>
                        <textarea id="descricao" class="form-control" rows="4" required placeholder="Digite aqui..."></textarea>
                    </div>

                    <div class="mb-4">
                        <label class="form-label"> Descrição atualizada do tipo de serviço desejado</label>
                        <textarea id="descricao" class="form-control" rows="4" required placeholder="Digite aqui..."></textarea>
                    </div>
